...
struct Phone
{
    char			description[20]; // Can be: CELL/HOME/WORK/TBA
    char			number[11];
};
...
void addAppointment(struct Appointment* appoints, int, struct Patient* patient, int);


// Remove an appointment record from the appointment array
// Todo:

void removeAppointment(struct Appointment* appoints, int, struct Patient* patient, int);
...
int sortAppointments(struct ClinicData* data, int, int);
